...
<section>
       ...
       <div class="ind_top">你的幸运卡<a href="javascript:void();" onclick="history.back(-1);" class="left"><img src="<?=base_url()?>static/lushang/images/back.png"></a><a href="<?=base_url()?>lucky/lotto?phone=<?=$userinfo['phone']?>" class="right" id="showmenu"><img src="<?=base_url()?>static/lushang/images/open.png">一键开奖</a></div>
       ...
       ?>
        <li><h2><?=$v['pro_name']?></h2><p class="number">编号<?=$v['rounds']?><?=$v['id']?></p><p class="lun">第<?=$v['rounds']?>轮</p><p class="zt">未开奖</p><font>未开奖</font><a href="<?=base_url()?>scratch/index?id=<?=$v['id']?>"></a></li>
        <?php
            }
          }
        ?>
